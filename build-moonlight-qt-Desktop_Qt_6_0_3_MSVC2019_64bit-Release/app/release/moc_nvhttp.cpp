...
#include <memory>
#include "../../../moonlight-qt/app/backend/nvhttp.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_NvHTTP_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_NvHTTP_t qt_meta_stringdata_NvHTTP = {
    {
QT_MOC_LITERAL(0, 6) // "NvHTTP"
...
const QMetaObject NvHTTP::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_NvHTTP.offsetsAndSize,
    qt_meta_data_NvHTTP,
    qt_static_metacall,
    nullptr,
    nullptr,
