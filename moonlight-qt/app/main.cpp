...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("HPLDIC Game Streaming Project");
    QCoreApplication::setOrganizationDomain("moonlight-stream.com");
    QCoreApplication::setApplicationName("HPLDIC");
...
//    app.setWindowIcon(QIcon(":/res/moonlight.svg"));
    app.setWindowIcon(QIcon(":/res/cloudgaming.svg"));
#endif
