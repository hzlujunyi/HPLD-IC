    ...
    function addComplete(success, detectedPortBlocking)
    {
        if (!success) {
            ...
            if (detectedPortBlocking) {
                errorDialog.text += "\n\n" + qsTr("This PC's Internet connection is blocking Cloudgaming. Streaming over the Internet may not work while connected to this network.")
            }
            else {
