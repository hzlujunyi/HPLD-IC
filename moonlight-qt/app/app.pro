...
unix:!macx: {
    ...
    icons.files = res/cloudgaming.svg
...
win32 {
    RC_ICONS = cloudgaming.ico
    QMAKE_TARGET_COMPANY = HPLDIC Game Streaming Project
    QMAKE_TARGET_DESCRIPTION = HPLDIC Game Streaming Client
    QMAKE_TARGET_PRODUCT = HPLDIC
